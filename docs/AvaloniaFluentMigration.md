...
| Rounded backdrop | Windows composition clips with the app window. | A native effect view does not inherit Avalonia border clipping. Set the native layer corner radius and `masksToBounds`, and keep the Avalonia root clipped too. |
